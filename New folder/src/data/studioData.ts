...
export const DISCIPLINES: Discipline[] = [
  {
    ...
    deliverables: ['Editorial Typography', 'Posters & Print Collateral', 'Spatial Exhibition Design', 'Art Direction', 'Book & Packaging']
  },
  {
    id: 'brand-identity',
    index: '02',
    ...
    deliverables: ['Custom Typography', 'Brand Guidelines', 'Packaging Systems', 'Spatial Identity', 'Design Systems & Tokens']
  },
  {
    ...
    deliverables: ['Concept Styling', 'Digital Cockpit HMI', 'Exterior 3D Renders', 'Vehicle Motion Reveal', 'Launch Keynotes']
  },
  {
    id: 'motion-graphics',
    index: '04',
    ...
    deliverables: ['Keynote Sequences', 'Kinetic Typography', 'Brand Motion Systems', '3D Motion Graphics', 'UI Micro-interactions']
  },
  {
    id: 'animation',
    index: '05',
    ...
    deliverables: ['Character Animation', 'Frame-by-Frame 2D', 'Procedural 3D FX', 'Narrative Storyboarding', 'Commercial Films']
  },
  {
    id: '3d-visualization',
    index: '06',
    ...
    deliverables: ['CAD Shader Development', 'Cinematic Renders', 'Interactive 3D Viewers', 'Architectural CGI', 'Raytraced Environments']
  },
  {
    id: 'visual-effects',
    index: '07',
    ...
    previewImage: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?auto=format&fit=crop&w=1600&q=80',
    ...
    deliverables: ['Matchmoving & Tracking', 'Particle Simulations', 'Matte Painting', 'Color Grading & Finishing', 'Atmospheric Compositing']
  },
  {
    ...
    deliverables: ['Macro Product Renders', 'Exploded View Animations', 'Material Study Shaders', 'E-commerce 3D Viewers']
  },
  {
    id: 'ui-ux-design',
    index: '09',
    ...
    deliverables: ['E-Commerce Platforms', 'Design Systems & Tokens', 'Interactive Prototypes', 'Spatial UI & Vision OS']
  }
];
